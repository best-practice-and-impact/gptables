...
cover = gpt.Cover(
    ...
    about=[[{"bold": True}, "Publication dates"],
           ...
           [{"bold": True}, "Note on weighting methodology"],
           ...
           [{"bold": True}, "Comparing quarterly changes"],
           ...
           [{"bold": True}, "Units, notes and no data"],
           ...
           [{"bold": True}, "Historic publication dates for labour market statistics", " "],
           ...
           [{"bold": True}, "More labour market data"],
